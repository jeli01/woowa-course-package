...
class BadgeTest {
    ...
    void obtainBadgeLess5000Price() {
        ...
        Assertions.assertThat(Badge.obtainBadgeByPrice(totalBenefitPrice)).isEqualTo(null);
    }
    ...
    void obtainBadgeMore5000Price() {
        ...
        Assertions.assertThat(Badge.obtainBadgeByPrice(totalBenefitPrice)).isEqualTo(Badge.STAR);
    }
    ...
    void obtainBadgeMore10000Price() {
        ...
        Assertions.assertThat(Badge.obtainBadgeByPrice(totalBenefitPrice)).isEqualTo(Badge.TREE);
    }
    ...
    void obtainBadgeMore20000Price() {
        ...
        Assertions.assertThat(Badge.obtainBadgeByPrice(totalBenefitPrice)).isEqualTo(Badge.SANTA);
    }
}